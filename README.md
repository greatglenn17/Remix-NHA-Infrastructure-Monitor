...
[![Latest Release](https://img.shields.io/badge/Release-v1.1.4%20%28Build%20114%29-0284C7?style=for-the-badge)](https://github.com/greatglenn17/Remix-NHA-Infrastructure-Monitor/releases)
...
2. Tap the latest release (`v1.1.4`).
3. Under **Assets**, tap **`NHA_Monitor_v1.1.4_Build114.apk`** to download the installation package.
